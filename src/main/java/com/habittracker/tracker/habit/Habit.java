...
public class Habit {
    ...
    public Habit(Long id, String name, String description, String icon, LocalTime reminder, int streak) {
        this.id = id;
        this.name = name;
    ...
    public Habit(String name, String description, String icon, LocalTime reminder, int streak) {
        this.name = name;
        this.description = description;
        this.icon = icon;
        this.reminder = reminder;
